            ...
            <div className="flex flex-col w-full min-h-0">
              ...
              <div className="flex w-full items-center justify-center py-2 shrink-0">
                <div className="flex gap-2">
                    <Button className="!rounded-full hud-frame p-2 bg-[#0c2d30] shadow-sm  cursor-pointer hover:bg-[#144D52] text-white !h-10 !w-10"> <Users size={16}/></Button>
                     <Button className="!rounded-full hud-frame p-2 bg-[#0c2d30] shadow-sm  cursor-pointer hover:bg-[#144D52] text-white !h-10 !w-10"> <Send size={16}/></Button>
